  ...
  useEffect(() => {
    ...
    createWorkspaceForOrg()
      ...
      .catch((e: unknown) => {
        if (!cancelled) {
          console.error(e);
          setError("Something went wrong provisioning your workspace.");
  ...
  return (
    <OnboardingShell>
      ...
      <div className="flex justify-center">
        {/* OrganizationList lets returning users select their existing org,
        ...
        <OrganizationList
          ...
          appearance={{
            ...
            elements: {
              ...
              card: "shadow-card rounded-2xl border border-border w-full",
              formButtonPrimary:
