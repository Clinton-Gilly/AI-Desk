          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                ...
                tag on any page. Your{" "}
                <code className="rounded-md bg-muted px-1.5 py-0.5 font-mono text-[0.8em] text-foreground">
                  app_id
                </code>{" "}
                is your workspace id — it&apos;s safe to expose publicly.
              </p>

              {/* Code block */}
              <div className="group relative mt-4 overflow-hidden rounded-xl bg-ink shadow-elevated">
                ...
                <pre className="overflow-x-auto px-4 py-4">
                  <code className="font-mono text-[13px] leading-relaxed whitespace-pre-wrap break-all text-white/90">
                    {snippet}
                  </code>
                </pre>
              </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                ...
                anywhere it loads on every page. The messenger bubble appears in
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                ...
                with the snippet already wired up to your{" "}
                <code className="rounded-md bg-muted px-1.5 py-0.5 font-mono text-[0.8em] text-foreground">
                  app_id
                </code>
                .
              ...
              <div className="mt-4 flex items-start gap-2.5 rounded-xl border border-border bg-card p-3.5">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  ...
                  <span className="font-medium text-foreground">Inbox</span> — it
                  appears live. Reply from the Inbox and it shows up in the
                  bubble instantly.
                </p>
              </div>
            </div>
