...
async function ensureWorkspaceForOrg(
  ctx: MutationCtx,
  args: { clerkOrgId: string; name?: string; slug?: string; ownerClerkUserId?: string },
...
const STATUS_MAP: Record<string, "active" | "past_due" | "canceled" | "ended" | "incomplete" | "expired"> = {
  active: "active",
  pastDue: "past_due",
  past_due: "past_due",
  canceled: "canceled",
